...
from ..parser import parse_table, parse_startlist
...
class RaceEditionExtResults(RaceEditionResults):
    def __init__(self, response, **kwargs):
        super().__init__(response, **kwargs)

    def _get_results_table(self):
        team_tables = self.soup.find_all('table', {'class': 'tablesorter'})
        self.results_table = parse_startlist(team_tables, self.res)
