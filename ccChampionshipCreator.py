    ...
    for kk in range(kkinit, endkk):  # endkk
        ...
        if 1 == 1:
            ...
            for ii in range(2018, 2019):
                ...
                # Search previous
                Yearprevious = Year - 1
                mylabelprevious = ccChampionshipLabel(
                ...
                time.sleep(1.0)
                mylabelEnLigne = ccChampionshipEnLigneLabel(
                ...
                # Link to next
                mylabelEnLignenext = ccChampionshipEnLigneLabel(
                ...
                time.sleep(1.0)
                if clm == 1:
                    mylabelClm = ccChampionshipClmLabel(
                        teamTable, kk, Year, ManOrWoman)
                    ...
                    ccChampionshipEnLigneBasic(
                        pywikibot, repo, itemClm, site, teamTable[kk][IndexClmRace], Year)
                    ...
                    # Link to next
                    mylabelClmnext = ccChampionshipClmLabel(
                        teamTable, kk, Yearnext, ManOrWoman)
